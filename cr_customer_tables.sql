...
CREATE TABLE Address_type (
	ADDRESS_TYPE_CODE varchar (3) PRIMARY KEY ,
...
CREATE TABLE Contact (
	CONTACT_ID int PRIMARY KEY ,
	CONTACT_TYPE_ID varchar (2) ,
	CONTACT_NAME varchar (100),
	CONTACT_MIDLENAME varchar (100),
	CONTACT_LASTNAME varchar (100),
	CONTACT_POSITION varchar (100),
	CONTACT_EMAIL varchar (100),
	PHONE_TYPE_ID varchar (50),
	PHONE varchar (20),
);

CREATE TABLE Contact_Type (
	CONTACT_TYPE_ID varchar (2) PRIMARY KEY ,
	CONTACT_TYPE_DESCRIPTION varchar (100),
);

CREATE TABLE Contact_Phone_Type (
	PHONE_TYPE_ID varchar (50) PRIMARY KEY ,
